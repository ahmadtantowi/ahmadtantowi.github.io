...
const CONFIG = {
  ...
  seo: {
    ...
    description: 'Versatile backend engineer with extensive experience in designing, deploying, and enhancing applications in both cloud-based and on-premise environments. Proficient in Go and C#, with a strong focus on performance and scalability.',
    imageURL: '',
  },
  social: {
  ...
  resume: {
    fileUrl:
      'https://1drv.ms/b/c/2c05b74ecec7a66d/EYm7yDpRF3BImocZpNeG4W0BDQexHDD-MtXfq8jOZ233Mw?e=3ADRIX', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Go',
    'C#',
  ...
  educations: [
    {
      institution: 'Universitas Islam Negeri Bandung',
